...
export class OidcHelperService {
    ...
    private clientId = 'monitoringspa_spa';
    private scope = 'openid email phone profile offline_access roles monitoringspa_api';
    ...
    registerUser(userName: string, email: string, password: string) {
        ...
        return this.http
        .post(this.configurations.registerUrl, body, { headers: header });
    }
