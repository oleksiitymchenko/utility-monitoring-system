        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CounterType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ControllerRegistry", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ControllerRegistry_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ControllerRegistry_AspNetUsers_ApplicationUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedDate = table.Column<DateTime>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    ControllerRegistryId = table.Column<Guid>(nullable: false),
                    ImageUrl = table.Column<string>(nullable: true),
                    CounterValue = table.Column<long>(nullable: false),
                    ProcessedSuccessful = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelemetryRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TelemetryRecord_ControllerRegistry_ControllerRegistryId",
                        column: x => x.ControllerRegistryId,
                        principalTable: "ControllerRegistry",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ControllerRegistry_ApplicationUserId",
                table: "ControllerRegistry",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ControllerRegistry_ApplicationUserId1",
                table: "ControllerRegistry",
                column: "ApplicationUserId1");

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryRecord_ControllerRegistryId",
                table: "TelemetryRecord",
                column: "ControllerRegistryId");
        }
